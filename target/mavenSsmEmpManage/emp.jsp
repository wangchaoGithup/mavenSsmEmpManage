	...
	$('#dg').datagrid({    
	    ...
	    columns:[[    
	        ...
	        {field:'opt',title:'操作',width:160,align:'center',
	        	formatter: function(value,row,index){
	        		var bt3="<input type='button' onclick=delById("+row.eid+") value='删除'/>"
	        		var bt4="<input type='button' onclick=findById("+row.eid+") value='编辑'/>"
	        		var bt5="<input type='button' onclick=editById("+row.eid+") value='详情'/>"
...
<div id="win" class="easyui-window" title="员工详情" style="width:600px;height:400px"   
  ...
  <p align="center">
<input type="button" value="员工添加" onclick="window.location.href='add.jsp'" >
<input type="button" value="部门管理" onclick="window.location.href='dep.jsp'">
</p>
</body>
</html>